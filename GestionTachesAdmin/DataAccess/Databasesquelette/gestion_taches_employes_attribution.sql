...
CREATE TABLE `attribution` (
  ...
  PRIMARY KEY (`matricule`,`id_tache`),
  KEY `id_tache` (`id_tache`),
  CONSTRAINT `attribution_ibfk_1` FOREIGN KEY (`matricule`) REFERENCES `employe` (`matricule`) ON DELETE CASCADE,
  CONSTRAINT `attribution_ibfk_2` FOREIGN KEY (`id_tache`) REFERENCES `tache` (`id_tache`) ON DELETE CASCADE
